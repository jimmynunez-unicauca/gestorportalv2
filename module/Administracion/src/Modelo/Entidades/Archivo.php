...
class Archivo implements InputFilterAwareInterface
{
    ...
    public function setIdResolucion($value)
    {
    ...
    public function setInicioConvocatoria($value)
    {
        $this->inicioConvocatoria = $value;
    }
    ...
    public function setFinConvocatoria($value)
    {
        $this->finConvocatoria = $value;
    }
