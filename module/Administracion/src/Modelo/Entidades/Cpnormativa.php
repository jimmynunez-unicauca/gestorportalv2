...
class Cpnormativa implements InputFilterAwareInterface
{

    private $idCPNormativa;
    private $idEmitido;
    private $nombre;
    private $descripcion;
    private $dirigido;
    ...
    public function getIdCPNormativa()
    {
        return $this->idCPNormativa;
    }

    public function setIdCPNormativa($value)
    {
        $this->idCPNormativa = $value;
    }
