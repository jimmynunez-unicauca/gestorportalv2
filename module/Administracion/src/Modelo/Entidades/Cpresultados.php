...
class Cpresultados implements InputFilterAwareInterface
{

    private $idCPResultados;
    private $idEmitido;
    private $nombre;
    private $descripcion;
    ...
    public function getIdCPResultados()
    {
        return $this->idCPResultados;
    }

    public function setIdCPResultados($value)
    {
        $this->idCPResultados = $value;
    }
    ...
    public function setIdEmitido($value)
    {
        $this->idEmitido = $value;
    }
