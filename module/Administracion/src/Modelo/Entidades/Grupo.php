...
class Grupo implements InputFilterAwareInterface
{
    ...
    public function getIdGI()
    {
        return $this->idGI;
    }

    public function setIdGI($value)
    {
        $this->idGI = $value;
    }
    ...
    public function getIdGVRI()
    {
        return $this->idGVRI;
    }

    public function setIdGVRI($value)
    {
        $this->idGVRI = $value;
    }

    public function getIdGSIVRI()
    {
        return $this->idGSIVRI;
    }

    public function setIdGSIVRI($value)
    {
        $this->idGSIVRI = $value;
    }

    public function getCodColombia()
    {
        return $this->codColombia;
    }

    public function setCodColombia($value)
    {
        $this->codColombia = $value;
    }
