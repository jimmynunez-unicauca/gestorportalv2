...
use Administracion\Modelo\DAO\RectoriaDAO;
use Administracion\Formularios\RectoriaForm;
...
class RectoriaController extends AbstractActionController
{
    ...
    private $rutaArchivos = '/var/www/html/newportal/archivos/rectoria/';
    /* private $rutaArchivos = './../archivos/rectoria/'; */
    //------------------------------------------------------------------------------
    ...
    //------------------------------------------------------------------------------
    function getFormulario($action = '', $idRectoria = 0)
    {
        $form = new RectoriaForm($action);
        if ($idRectoria != 0) {
            $rectoriaOBJ = $this->DAO->getRectoria($idRectoria);
    ...
    public function registrarAction()
    {
        ...
        //----------------------------------------------------------------------
        $form = new RectoriaForm('registrar');
    ...
    public function editarAction()
    {
        $request = $this->getRequest();
        if (!$request->isPost()) {
            $idRectoria = (int) $this->params()->fromQuery('idRectoria', 0);
            $infoRectoria = $this->DAO->getRectoriaDetalle($idRectoria);
            $form = new RectoriaForm('editar');
            $form->setData($infoRectoria);
            $view = new ViewModel([
                'form' => $form,
            ]);
            $view->setTerminal(true);
    ...
    {
        $idRectoria = (int) $this->params()->fromQuery('idRectoria', 0);
        $infoEmpleado = $this->DAO->getRectoriaDetalle($idRectoria);
    ...
    public function eliminarAction()
    {
        ...
        if (!$request->isPost()) {
            $idRectoria = (int) $this->params()->fromQuery('idRectoria', 0);
            $infoLven = $this->DAO->getRectoriaDetalle($idRectoria);
            $form = new RectoriaForm('eliminar');
        ...
        if (!$form->isValid()) {
            ...
            return $this->redirect()->toUrl('index?idRectoria=' . $this->params()->fromPost('idRectoria', 0));
        }
        //----------------------------------------------------------------------
        try {
            $rectoriaOBJ->exchangeArray($form->getData());
        ...
        return $this->redirect()->toUrl('index?idRectoria=' . $rectoriaOBJ->getIdRectoria());
    }
    public function activarAction()
    {
        ...
        if (!$request->isPost()) {
            $idRectoria = (int) $this->params()->fromQuery('idRectoria', 0);
            $infoArchivo = $this->DAO->getRectoriaDetalle($idRectoria);
            $form = new RectoriaForm('activar');
    ...
    {
        $idRectoria = (int) $this->params()->fromRoute('id1', 0);
        $archivos = $this->DAO->getRectoriaDetalle($idRectoria);
    ...
    {
        $idRectoria = (int) $this->params()->fromQuery('idRectoria', 0);
        $form = $this->getFormulario('actualizararchivo', $idRectoria);
        $request = $this->getRequest();
        if ($request->isPost()) {
            $form->setData($request->getPost());
            if ($form->isValid()) {
                $session = $this->getInfoSesion();
                $rectoriaOBJ = new Rectoria($form->getData());
                //----------------------------------------------------------------------
                $files = $request->getFiles()->toArray();
                //----------------------------------------------------------------------
                $uploadOK = new \Laminas\Validator\File\UploadFile();
