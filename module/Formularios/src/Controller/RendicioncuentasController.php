...
use Formularios\Modelo\DAO\RendicioncuentasDAO;

class RendicioncuentasController extends AbstractActionController
{

    private $DAO;
    //------------------------------------------------------------------------------

    public function __construct(RendicioncuentasDAO $dao)
    {
        $this->DAO = $dao;
    }
