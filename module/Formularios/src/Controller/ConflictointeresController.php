...
use Formularios\Modelo\DAO\ConflictointeresDAO;

class ConflictointeresController extends AbstractActionController
{

    private $DAO;
    //------------------------------------------------------------------------------

    public function __construct(ConflictointeresDAO $dao)
    {
        $this->DAO = $dao;
    }
