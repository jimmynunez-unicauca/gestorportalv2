...
use Formularios\Modelo\DAO\CentroposgradoDAO;

class CentroposgradoController extends AbstractActionController
{

    private $DAO;
    //------------------------------------------------------------------------------

    public function __construct(CentroposgradoDAO $dao)
    {
        $this->DAO = $dao;
    }
