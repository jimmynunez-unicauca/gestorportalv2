...
use Formularios\Modelo\DAO\DaepropiedadDAO;

class DaepropiedadController extends AbstractActionController
{

    private $DAO;
    //------------------------------------------------------------------------------

    public function __construct(DaepropiedadDAO $dao)
    {
        $this->DAO = $dao;
    }
