...
class Calendarioacademico implements InputFilterAwareInterface
{
    ...
    public function getIdCalendarioAcademico()
    {
        return $this->idCalendarioAcademico;
    }

    public function setIdCalendarioAcademico($value)
    {
        $this->idCalendarioAcademico = $value;
    }
