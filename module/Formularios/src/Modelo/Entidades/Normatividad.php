...
class Normatividad implements InputFilterAwareInterface
{
    ...
    public function getIdNormatividad()
    {
        return $this->idNormatividad;
    }

    public function setIdNormatividad($value)
    {
        $this->idNormatividad = $value;
    }
