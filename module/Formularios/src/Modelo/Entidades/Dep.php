...
class Dep implements InputFilterAwareInterface
{

    private $idform_dependencia;
    private $dependencia;
    private $estado;
    ...
    public function getIdform_dependencia()
    {
        return $this->idform_dependencia;
    }

    public function setIdform_dependencia($value)
    {
        $this->idform_dependencia = $value;
    }
