...
class Ita implements InputFilterAwareInterface
{
    ...
    //------------------------------------------------------------------------------
    public function getIdITA()
    {
        return $this->idITA;
    }

    public function setIdITA($value)
    {
        $this->idITA = $value;
    }
    ...
    public function setTipoInformacion($value)
    {
        $this->tipoInformacion = $value;
    }
