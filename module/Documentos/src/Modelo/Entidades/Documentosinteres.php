...
class Documentosinteres implements InputFilterAwareInterface
{

    private $idDocumentosInteres;
    private $idLvmen;
    private $nombre;
    private $estado;
    ...
    public function getIdDocumentosInteres()
    {
        return $this->idDocumentosInteres;
    }

    public function setIdDocumentosInteres($value)
    {
        $this->idDocumentosInteres = $value;
    }
    ...
    public function setIdLvmen($value)
    {
        $this->idLvmen = $value;
    }
