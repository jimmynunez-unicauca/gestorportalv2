...
class Archivohistorico implements InputFilterAwareInterface
{

    private $idarchivo_historico;
    private $nombre;
    private $descripcion;
    private $publicacion;
    private $emitido;
    ...
    public function getIdarchivo_historico()
    {
        return $this->idarchivo_historico;
    }

    public function setIdarchivo_historico($value)
    {
        $this->idarchivo_historico = $value;
    }
    ...
    public function setEmitido($value)
    {
        $this->emitido = $value;
    }
