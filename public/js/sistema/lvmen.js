...
function actualizarArchivo() {
    var idLvmen = $("#idLvmen").val();
    $.get('actualizararchivo', { idLvmen: idLvmen }, setFormulario);
    bloqueoAjax();
}
...
//------------------------------------------------------------------------------
function verSubirBPMN(idLvmen) {
    $.get('subirppmn', { idLvmen: idLvmen }, setFormulario);
    bloqueoAjax();
}
function cambiarBPMN(idLvmen, id_bpmn) {
    $.get('cambiarbpmn', { idLvmen: idLvmen, id_bpmn: id_bpmn }, setFormulario);
    bloqueoAjax();
}
function actualizarBPMN() {
    var id_bpmn = $("#id_bpmn").val();
    var idLvmen = $("#idLvmen").val();
    $.get('actualizarbpmn', { id_bpmn: id_bpmn, idLvmen: idLvmen }, setFormulario);
    bloqueoAjax();
}
//------------------------------------------------------------------------------