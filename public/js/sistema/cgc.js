...
function verEditar(idCGC) {
    $.get('editar', { idCGC: idCGC }, setFormulario);
    bloqueoAjax();
}
function verDetalle(idCGC) {
    $.get('detalle', { idCGC: idCGC }, setFormulario);
    bloqueoAjax();
}
function verEliminar(idCGC) {
    $.get('eliminar', { idCGC: idCGC }, setFormulario);
    bloqueoAjax();
}
function verActivar(idCGC) {
    $.get('activar', { idCGC: idCGC }, setFormulario);
    bloqueoAjax();
}
...
function actualizarArchivo() {
    var idCGC = $("#idCGC").val();
    $.get('actualizararchivo', { idCGC: idCGC }, setFormulario);
    bloqueoAjax();
}
