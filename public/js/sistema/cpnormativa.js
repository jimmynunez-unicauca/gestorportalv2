...
function verEditar(idCPNormativa) {
    $.get('editar', { idCPNormativa: idCPNormativa }, setFormulario);
    bloqueoAjax();
}
function verDetalle(idCPNormativa) {
    $.get('detalle', { idCPNormativa: idCPNormativa }, setFormulario);
    bloqueoAjax();
}
function verEliminar(idCPNormativa) {
    $.get('eliminar', { idCPNormativa: idCPNormativa }, setFormulario);
    bloqueoAjax();
}
function verActivar(idCPNormativa) {
    $.get('activar', { idCPNormativa: idCPNormativa }, setFormulario);
    bloqueoAjax();
}
...
function actualizarArchivo() {
    var idCPNormativa = $("#idCPNormativa").val();
    $.get('actualizararchivo', { idCPNormativa: idCPNormativa }, setFormulario);
    bloqueoAjax();
}
