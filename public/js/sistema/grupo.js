...
function verEditar(idGI) {
    $.get('editar', { idGI: idGI }, setFormulario);
    bloqueoAjax();
}
function verDetalle(idGI) {
    $.get('detalle', { idGI: idGI }, setFormulario);
    bloqueoAjax();
}
function verEliminar(idGI) {
    $.get('eliminar', { idGI: idGI }, setFormulario);
    bloqueoAjax();
}
function verActivar(idGI) {
    $.get('activar', { idGI: idGI }, setFormulario);
    bloqueoAjax();
}
...
function actualizarArchivo() {
    var idGI = $("#idGI").val();
    $.get('actualizararchivo', { idGI: idGI }, setFormulario);
    bloqueoAjax();
}
