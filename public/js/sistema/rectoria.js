...
function verEditar(idRectoria) {
    $.get('editar', { idRectoria: idRectoria }, setFormulario);
    bloqueoAjax();
}
function verDetalle(idRectoria) {
    $.get('detalle', { idRectoria: idRectoria }, setFormulario);
    bloqueoAjax();
}
function verEliminar(idRectoria) {
    $.get('eliminar', { idRectoria: idRectoria }, setFormulario);
    bloqueoAjax();
}
function verActivar(idRectoria) {
    $.get('activar', { idRectoria: idRectoria }, setFormulario);
    bloqueoAjax();
}
...
function actualizarArchivo() {
    var idRectoria = $("#idRectoria").val();
    $.get('actualizararchivo', { idRectoria: idRectoria }, setFormulario);
    bloqueoAjax();
}
...
function selectTipo(tipo) {
    ...
    $("#formato").val('');
    if (tipo == 'Auditoría') {
        $("#divTipoInforme").show('slow');
        $("#divTipoFecha").hide("slow");
        $("#divFecha").hide("slow");
        $("#divDirigido").hide("slow");
        $("#divFormato").hide("slow");
        //-------------------------------------
        $('#tipoInforme').attr('required', true);
        $('#tipoFecha').attr('required', false);
        $('#fecha').attr('required', false);
        $('#dirigido').attr('required', false);
        $('#formato').attr('required', false);
    } else if (tipo == 'Interno') {
        $("#divTipoInforme").hide("slow");
        $("#divTipoFecha").show("slow");
        $("#divFecha").show("slow");
        $("#divDirigido").hide("slow");
        $("#divFormato").hide("slow");
        //-------------------------------------
        $('#tipoInforme').attr('required', false);
        $('#tipoFecha').attr('required', true);
        ...
        $("#divTipoFecha").show("slow");
        $("#divFecha").show("slow");
        $("#divDirigido").show("slow");
        $("#divFormato").show("slow");
        //-------------------------------------
        $('#tipoInforme').attr('required', false);
        $('#tipoFecha').attr('required', true);
        $('#fecha').attr('required', true);
        $('#dirigido').attr('required', true);
